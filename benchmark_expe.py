...
def custom_experiments(scenes, args):

    for i in range(3):
        # repete experience a few times
        #reg_args = f"--maxvariance_regularization 0.0001 --edge_regularization 0.005 --smoothness_regularization 0.0001" # for raindeer
        reg_args = f"--maxvariance_regularization 0.00001 --edge_regularization 0.001 --smoothness_regularization 0.00001"
...
def main():
    ...
    if args.expe_config is None and args.grid_search_regularization is None:
        ...
        custom_experiments(scenes,args)
    else:
